        ...
        <Fragment>
            <div class="badydiv">
                <div class="universalDiv">
                    ...
                    <div className='content' style={{height: 'calc(100% - 167px)',overflow: 'scroll'}}>
                                                    ...
                                                    <div class="productview">
                                                        <div class="swiper-wrapper">
                                                            <div class="swiper-slide">
                                                                <div class="brandbox">
                                                                    <img src="https://images.bewakoof.com/t540/navy-blue-full-sleeve-t-shirt-men-s-plain-full-sleeve-t-shirts-1092-1538998804.jpg" class="img-fluid" />
                                                                </div>
                                                            </div>
                                                            <div class="swiper-slide">
                                                                <div class="brandbox">
                                        ...
                                        <div class="col-12">
                                            <div class="flashsale">
                                                <div class="productdetails text-left txt">
                                                    <h5 class="p-name">Navy Blue Full Sleeve T-Shirt</h5>
                                                    <div class="price d-flex float-left">
                                                        ...
                                                        <span class="offp" style={{margin:'4px 0 0 5px'}}>50% off</span>
                                                    </div>
                                                ...
                                                <div class="delivery text-left">
                                                    ...
                                                    <div class="changepin mt-4">
                                                        <div class="form-group d-flex" style={{position: 'relative'}}>
                                                            <ShiftLabel styles={{position:"absolute",marginTop: '-7px'}} className={'initial'} labelFor={"pincode"} title={"Enter Pincode"} />
                                                            <input id='pincode' onFocus={handleFocus} onBlur={handleBlur} style={{ border: '1px solid #000' }} type="text" class="form-control" />
                                                                ...
                                                                <div class="ratingview">
                                                                    ...
                                                                    <div class="productimg text-left">
                                                                        <div class="imgbox d-flex">
                                                                            <img src="https://images.bewakoof.com/t540/navy-blue-full-sleeve-t-shirt-men-s-plain-full-sleeve-t-shirts-1092-1538998804.jpg" alt="" />
                                                                            <img src="https://images.bewakoof.com/t540/navy-blue-full-sleeve-t-shirt-men-s-plain-full-sleeve-t-shirts-1092-1538998804.jpg" alt="" />
                                                                            <img src="https://images.bewakoof.com/t540/navy-blue-full-sleeve-t-shirt-men-s-plain-full-sleeve-t-shirts-1092-1538998804.jpg" alt="" />
                                                                            <img src="https://images.bewakoof.com/t540/navy-blue-full-sleeve-t-shirt-men-s-plain-full-sleeve-t-shirts-1092-1538998804.jpg" alt="" />
                                                                            <img src="https://images.bewakoof.com/t540/navy-blue-full-sleeve-t-shirt-men-s-plain-full-sleeve-t-shirts-1092-1538998804.jpg" alt="" />
                                            ...
                                            <div class="swiper-wrapper">
                                                ...
                                                <div class="swiper-slide">
                                                    <div class="flasebox">
                                                        ...
                                                        <div class="txt">
                                                            <p class="productn">Navy Blue Full Sleeve T-Shirt</p>
                                                            <div class="price d-flex float-left">
                                                                <p class="m-price"><i class="fas fa-rupee-sign"></i> 599</p>
                                                                <span class="full-p"><i class="fas fa-rupee-sign"></i> 899</span>
                                                                <span class="offp" style={{margin: '0'}}>50% off</span>
                                                            </div>
                                                            <div class="rateing text-right">
                                                                <p class="rate"><a href="#" class="star">★ 4.2</a></p>
                                                            </div>
                    ...
                    <div class="stckyfooter">
                        <div>
                            <div>
                                <h6 style={{textAlign:"center", color:"gray", fontSize:"12px"}}><b>Offer Price</b></h6>
                                <h3 style={{textAlign:"center", fontSize:"19px"}}><b>&#8377;5999 - &#8377;100 = &#8377;5899</b></h3>
                            </div>
